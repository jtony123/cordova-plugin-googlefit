...
public class GoogleFit extends CordovaPlugin {
    ...
    DataType.AGGREGATE_BASAL_BODY_TEMPERATURE_SUMMARY,
    DataType.AGGREGATE_BLOOD_GLUCOSE_SUMMARY,
    DataType.AGGREGATE_BLOOD_PRESSURE_SUMMARY,
    DataType.AGGREGATE_BODY_TEMPERATURE_SUMMARY,
    DataType.AGGREGATE_OXYGEN_SATURATION_SUMMARY,
    DataType.TYPE_BASAL_BODY_TEMPERATURE,
    DataType.TYPE_BLOOD_GLUCOSE,
    DataType.TYPE_BLOOD_PRESSURE,
    DataType.TYPE_BODY_TEMPERATURE,
    DataType.TYPE_CERVICAL_MUCUS,
    DataType.TYPE_CERVICAL_POSITION,
    DataType.TYPE_MENSTRUATION,
    DataType.TYPE_OVULATION_TEST,
    DataType.TYPE_OXYGEN_SATURATION,
    DataType.TYPE_VAGINAL_SPOTTING,
    DataType.TYPE_CERVICAL_MUCUS
    };
